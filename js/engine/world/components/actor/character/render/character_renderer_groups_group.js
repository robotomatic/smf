...
CharacterRendererGroupsGroup.prototype.renderGroup = function(gamecanvas, character, groupdef, groupnames, group, debugrects, debug) {
    ...
    if (gg.link && gg.link != "skip") {
        return this.renderGroupLinkPath(gamecanvas, linkpath, color, gg);
    } else {
...
CharacterRendererGroupsGroup.prototype.renderGroupLinkPath = function(gamecanvas, linkpath, color, gg) {
    if (!linkpath) {
...
CharacterRendererGroupsGroup.prototype.renderGroupClipPath = function(gamecanvas, gg) {
    if (gg.clip == "start") {
