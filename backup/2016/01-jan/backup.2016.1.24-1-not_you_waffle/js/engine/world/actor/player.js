...
Player.prototype.getState = function(dir) {
    var state = "";
...
Player.prototype.idle = function(now) {
    if (!this.look_straight && !this.look_left && !this.look_right && !this.isLookingLeft() && !this.isLookingRight()) {
        var dir = random(0, 2);
