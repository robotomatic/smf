function AnimationManager(name, animation, character) {
    ...
    this.animationNoReset = animation.noreset ? animation.noreset : false;
    this.currentFrame = 0;
        ...
        if (t > 1) {
            if (this.currentFrame < t) framenum = this.currentFrame;
                ...
                if (this.animationRepeat) {
                    if (this.animationNoReset) {
                        framenum = t - 1;
                        lerp = 1;
                    } else framenum = this.currentFrame = 0;
                } else {
...
//            if (part.parts) {
//                this.updateZIndex(animation.zindex, part.parts);
//            }
        }
...
//AnimationManager.prototype.updateZIndex = function(z, parts) {
//    
//    var keys = Object.keys(parts);
//    for (var i = 0; i < keys.length; i++) {
//        var p = parts[keys[i]];
//        p.zindex = ++z;
//        if (p.parts) this.updateZIndex(z, p.parts);
//    }
//    
//}