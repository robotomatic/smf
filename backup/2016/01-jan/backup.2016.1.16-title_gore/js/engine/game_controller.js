    ...
    this.loadUI(data, function() {
        ...
        controller.gameloader.loadMenu(
            ...
            function() {
                ...
                controller.game = new MenuMain(controller.gameloader, controller.devtools, controller.gamesettings.getSettings(controller.currentview));
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadGameParty(
            ...
            function() {
                ...
                controller.game = new GameParty(controller.gameloader, controller.devtools, gamesettings, levelsettings, playersettings);
                controller.start();
