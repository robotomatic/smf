...
Level.prototype.buildItems = function() {
    ...
    for (var i = 0; i < t; i++) this.layers[this.layerkeys[i]].buildItems(this.itemrenderer);
}
...
Level.prototype.renderStart = function(now, ctx, window, x, y, scale, quality, first) {
    var t = this.layers.length;
    for (var i = 0; i < t; i++) this.layers[i].renderStart(now, ctx, window, x, y, this.width, this.height, scale, quality, this.itemrenderer, first);
}

Level.prototype.render = function(now, ctx, window, x, y, scale, quality, first) {
    var t = this.layers.length;
...
Level.prototype.renderDebug = function(now, ctx, window, x, y, scale, quality, first, debug) {
    ...
    var t = this.layers.length;
    if (debug || this.debug) {
        for (var i = 0; i < t; i++) this.layers[i].renderDebug(now, ctx, window, x, y, this.width, this.height, scale, quality, this.itemrenderer, first);
    }
}

Level.prototype.renderEnd = function(now, ctx, window, x, y, scale, quality, first) {
    var t = this.layers.length;
    for (var i = 0; i < t; i++) this.layers[i].renderEnd(now, ctx, window, x, y, this.width, this.height, scale, quality, this.itemrenderer, first);
}
