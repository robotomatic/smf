...
Item3DRectangle.prototype.renderItem3D = function(now, ctx, item, renderer, window, x, y, width, height, depth, scale) {
    ...
    if (shouldProject(this.p2, this.p3, scale, x, y, width, height, wc, this.cp)) {
        this.polygon = project3D(this.p2, this.p3, depth, this.polygon, window.width, window.height, scale, x, y, wc, this.np1, this.np2);        
        ctx.beginPath();
        this.polygon.draw(ctx);
    }

    if (shouldProject(this.p4, this.p1, scale, x, y, width, height, wc, this.cp)) {
        this.polygon = project3D(this.p4, this.p1, depth, this.polygon, window.width, window.height, scale, x, y, wc, this.np1, this.np2);
        ctx.beginPath();
        this.polygon.draw(ctx);
    }
    ...
    if (shouldProject(this.p3, this.p4, scale, x, y, width, height, wc, this.cp)) {
        this.polygon = project3D(this.p3, this.p4, depth, this.polygon, window.width, window.height, scale, x, y, wc, this.np1, this.np2);
