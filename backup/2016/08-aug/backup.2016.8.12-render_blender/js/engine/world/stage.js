...
Stage.prototype.render = function(now, ctx, window, x, y, scale, levelquality, playerquality, first) { 
    this.stagerenderer.render(now, ctx, this, window, x, y, scale, levelquality, playerquality, first);
}
