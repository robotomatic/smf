...
ItemRenderManagerRenderer.prototype.drawItemTheme = function(ctx, color, item, window, x, y, width, height, titem, scale, drawdetails, ox, oy) { 
    ...
    if (titem.itemtype == "group") {
        ...
        if (material) {
            ...
            this.itemmaterals.render(ctx, color, material, item, this.polygon, window, x, y, width, height, titem, scale, drawdetails, ox, oy);
        } else {
        ...
        var top = titem.top;
        if (top) {
            this.drawPlatformTops(ctx, item, x, y, scale, top);
        }
    ...
    if (material) {
        ...
        var m = this.itemmaterals.render(ctx, color, material, item, this.polygon, window, x, y, width, height, titem, scale, drawdetails, ox, oy);
        if (m) return;
    }
