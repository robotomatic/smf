...
Stage.prototype.render = function(now, graphics, window, x, y, width, height, scale, levelquality, playerquality) { 
    this.stagerenderer.render(now, graphics, this, window, x, y, width, height, scale, levelquality, playerquality);
}
