...
Item3DPolygon.prototype.renderItem3D = function(now, ctx, item, renderer, window, x, y, depth, scale) {
    ...
    this.drawItemPartsPolygon3D(ctx, this.polygon, {"sides" : this.sidecolor, "top" : this.topcolor, "bottom" : this.bottomcolor}, depth, scale, x, y, window, true, false);
