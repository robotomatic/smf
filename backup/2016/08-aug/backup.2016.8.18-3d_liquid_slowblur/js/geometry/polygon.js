...
Polygon.prototype.addPoint = function(point) {
    ...
    for (var i = 0; i < t; i++) {
        var p = this.points[i];
        var d = distance(p.x, p.y, point.x, point.y);
        if (d == 0) {
            ok = false;
            break;
        }
...
//        this.points[1] = new Point(item.width, 0);
//        this.tops[0] = new Line(this.points[0], this.points[1]);
//        
//
//        this.points[2] = new Point(item.width, item.height);
//        this.sides[0] = new Line(this.points[1], this.points[2]);
//        
//        this.points[3] = new Point(0, item.height);
