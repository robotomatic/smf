...
ItemRendererGrass.prototype.draw = function(ctx, color, item, window, x, y, width, height, titem, scale) {
    this.drawGrass(ctx, item, x, y, width, height, scale, titem, drawdetails);
}

ItemRendererGrass.prototype.drawGrass = function(ctx, item, x, y, width, height, scale, titem) {
