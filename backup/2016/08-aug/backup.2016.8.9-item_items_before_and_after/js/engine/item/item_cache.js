...
ItemCache.prototype.cacheItem = function(ctx, item, window, renderer, scale, quality, blur, parallax) {
    ...
    if (!cacheitem) {
        ...
        if (renderer) renderer.drawItem(cacheitem.ctx, item.color, item, window, 0, 0, box, this.quality, false, false);
        else {
