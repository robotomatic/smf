...
Item.prototype.render = function(now, ctx, window, x, y, scale, renderer) {
    ...
    if (renderer) renderer.drawItem(ctx, this.color, this, window, x, y, this.box, scale);
    else {
...
Item.prototype.renderCache = function(ctx, window, x, y, box, scale, tops, renderer) {
    if (renderer) renderer.drawItemCacheItems(ctx, this.color, this, window, x, y, box, scale, tops);
}

Item.prototype.renderBefore = function(now, ctx, window, x, y, scale, renderer) {
    if (renderer) renderer.drawItemBefore(ctx, this.color, this, window, x, y, this.box, scale);    
}

Item.prototype.renderAfter = function(now, ctx, window, x, y, scale, renderer) {
    if (renderer) renderer.drawItemAfter(ctx, this.color, this, window, x, y, this.box, scale);    
}
