...
//    stage.level.renderAfter(now, ctx, this.window, x, y, scale, this.quality, this.first, this.debug, players);
    
    if (players  && players.players && players.players.length) {
        players.render(now, this.window, ctx, x, y, scale, this.playerquality);
//        stage.level.renderColliders(now, this.window, ctx, x, y, scale, this.quality, this.first, players);
        players.renderTop(now, this.window, ctx, x, y, scale, this.playerquality);
    }
  
    stage.level.renderAfter(now, ctx, this.window, x, y, scale, this.quality, this.first, this.debug);
