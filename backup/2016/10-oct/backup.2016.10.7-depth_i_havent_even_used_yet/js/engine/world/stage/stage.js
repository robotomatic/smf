...
Stage.prototype.render = function(now, graphics, window, x, y, scale, levelquality, playerquality) { 
    this.stagerenderer.render(now, graphics, this, window, x, y, scale, levelquality, playerquality);
}

Stage.prototype.reset = function(now, graphics) { 
    this.level.reset(now);
    this.stagerenderer.reset(now);
}
