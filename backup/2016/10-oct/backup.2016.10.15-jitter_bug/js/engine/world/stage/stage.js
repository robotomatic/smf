...
Stage.prototype.render = function(now, graphics, window, levelquality, playerquality) { 
    this.stagerenderer.render(now, graphics, this, window, levelquality, playerquality);
}
