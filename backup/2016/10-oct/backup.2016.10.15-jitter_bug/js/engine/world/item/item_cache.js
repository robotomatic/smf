...
ItemCache.prototype.cacheItem = function(now, ctx, item, renderer, window, width, height, quality, floodlevel) {
    ...
    this.item3D.createItem3D(item, renderer, window, x, y, scale, floodlevel);
...
//    var gctx = this.temp.ctx;
    ...
    this.item3D.renderItem3D(now, gctx, item, renderer, 0, 0);
    this.renderItem(now, gctx, item, renderer, window, px, py, pz, pw, ph, scale, quality, floodlevel);
    this.debugItem(now, gctx, item, renderer, window, px, py, pz, pw, ph, scale);
...
ItemCache.prototype.renderItem = function(now, ctx, item, renderer, window, ox, oy, oz, width, height, scale, quality, floodlevel) {
