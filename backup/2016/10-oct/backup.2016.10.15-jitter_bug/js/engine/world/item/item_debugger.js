...
//    this.rect.drawOutline(ctx, color, 1);
    ...
    for (var pi = 0; pi < pt; pi++) {
        ...
        var p = new Point(this.rect.x, this.rect.y);
        p = projectPoint3D(p, depth, scale, x, y, wc, p);
        
        this.rect.x = p.x;
        this.rect.y = p.y;
        
        this.rect.width *= item.scalefactor;
        this.rect.height *= item.scalefactor;
