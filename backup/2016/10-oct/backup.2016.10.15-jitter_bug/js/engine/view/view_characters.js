...
function CharactersView(id, playertotal, playernum, width, height, scale, levelquality, playerquality) {
...
CharactersView.prototype.update = function(now, delta, game) {
...
CharactersView.prototype.render = function(now, game) {
