...
ViewRenderer.prototype.render = function(now, stage, view, graphics) {
    ...
    this.mbr.scale = scale;
    
    stage.render(now, graphics, this.mbr, this.levelquality, this.playerquality);
    ...
    if (this.tiltshift) this.renderTilt(view, stage, this.mbr, width, height, scale);
}

ViewRenderer.prototype.renderTilt = function(view, stage, mbr, width, height, scale) {
