...
ItemCache.prototype.cacheItem = function(now, ctx, item, renderer, mbr, window, width, height, quality, floodlevel) {
    ...
    this.item3D.createItem3D(item, renderer, mbr, x, y, scale, floodlevel);
...
//    var gctx = this.temp.ctx;
    ...
    this.renderItem(now, gctx, item, renderer, mbr, px, py, pz, pw, ph, scale, quality, floodlevel);
