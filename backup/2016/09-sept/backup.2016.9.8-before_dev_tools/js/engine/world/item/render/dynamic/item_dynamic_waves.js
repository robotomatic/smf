...
ItemDynamicWaves.prototype.draw = function(ctx, color, item, window, x, y, width, height, titem, scale) {
    this.drawWaves(ctx, color, item, window, x, y, width, height, scale, titem);
}

ItemDynamicWaves.prototype.drawWaves = function(ctx, color, item, window, x, y, width, height, scale, wave) {
