...
PlayerRenderer.prototype.draw = function(now, ctx, x, y, width, height, scale, quality, debug) {
    ...
    if (debug) this.playerdebugger.drawDebug(now, ctx, x, y, width, height, scale);
}