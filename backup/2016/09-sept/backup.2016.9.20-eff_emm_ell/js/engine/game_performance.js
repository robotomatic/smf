...
GamePerformance.prototype.tick = function(when) {
    ...
    if (this.lt) {
        ...
        this.atps = this.calculateAverageFPS(this.tps, this.nt);
    }
    this.lt = when;
...
GamePerformance.prototype.updateStart = function(when) {
    ...
    if (this.lu) {
        ...
        this.aups = this.calculateAverageFPS(this.ups, this.nu);
    }
    this.lu = when;
...
GamePerformance.prototype.updateEnd = function(when) {
    // todo: can use this to see how long updates take
}
...
GamePerformance.prototype.renderStart = function(when) {
    ...
    if (this.lr) {
        ...
        this.arps = this.calculateAverageFPS(this.rps, this.nr);
    }
    this.lr = when;
...
GamePerformance.prototype.renderEnd = function(when) {
    // todo: can use this to see how long renders take
}
