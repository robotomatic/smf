...
ItemCache.prototype.cacheItem = function(ctx, item, window, renderer, scale, details, quality, blur, parallax) {
    ...
    if (renderer) renderer.drawItem(cacheitem.ctx, item.color, item, window, 0, 0, box, this.quality, details);
    else {
