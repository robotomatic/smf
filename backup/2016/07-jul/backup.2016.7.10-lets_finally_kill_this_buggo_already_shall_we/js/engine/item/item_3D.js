...
Item3D.prototype.renderItem3D = function(now, ctx, window, x, y, item, width, height, scale, quality, renderer, depth, top, parallax) {
    ...
    else this.renderItemRect3D(now, ctx, item, renderer, window, x, y, width, height, scale, depth);
}

Item3D.prototype.renderItemRect3D = function(now, ctx, item, renderer, window, x, y, width, height, scale, depth) {
...
// todo: this should only be done once. Need a class to draw and store with item
