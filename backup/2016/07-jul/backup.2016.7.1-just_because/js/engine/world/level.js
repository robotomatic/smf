...
Level.prototype.render = function(now, ctx, window, x, y, scale, quality, first, debug) {
    ...
    for (var i = 0; i < t; i++) {
        this.layers[i].render(now, ctx, window, x, y, this.width, this.height, scale, quality, this.itemrendermanager, first);
    }
    if (debug || this.debug) {
        for (var i = 0; i < t; i++) {
            this.layers[i].debugLayer(now, ctx, window, x, y, this.width, this.height, scale, quality, this.itemrendermanager, first);
        }
    }
