...
ItemRendererWood.prototype.draw = function(ctx, color, item, window, x, y, width, height, titem, scale, drawdetails) {
    this.drawSupport(ctx, item, x, y, width, height, titem, drawdetails);
}
