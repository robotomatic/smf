...
ItemRendererRock.prototype.draw = function(ctx, color, item, window, x, y, width, height, titem, scale, drawdetails) {
    this.drawRock(ctx, item, x, y, width, height, scale, titem, drawdetails);
}
