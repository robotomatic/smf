...
function MenuPlayerChooser(gamecontroller, parent) {
    ...
    this.device = "";
    this.gamequality = new GameQuality(this, 3);
...
MenuPlayerChooser.prototype.loadLevel = function() { 
...
MenuPlayerChooser.prototype.loadPlayer = function(id, x, y, z, character) {
    ...
    var speed = 2;
    var player = new Player(id, character.name, "", x + pdiff, y, z, pw, ph, speed, char);
...
MenuPlayerChooser.prototype.loadView = function(i) {
    ...
    this.loadUI(i);
    return new CharactersView(i + "-ui-player-chooser-canvas", this.playertotal, i, w, h, s, lq, pq);
}
...
MenuPlayerChooser.prototype.doCharacterChange = function(dir, destx, playernum, playerx, playery, character, newnum) {
    ...
    this.loop.game.stage.players.players[playernum + 4] = player;
    this.loop.game.stage.npcs.npcs[playernum + 4] = npc;
...
MenuPlayerChooser.prototype.finishCharacterChange = function(playernum, player, npc, newnum) {
    ...
    this.loop.game.stage.players.players[playernum] = player;
    this.loop.game.stage.npcs.npcs[playernum] = npc;
    ...
    this.loop.game.stage.players.players[playernum + 4] = null;
    this.loop.game.stage.npcs.npcs[playernum + 4] = null;
}
