...
ItemCache.prototype.renderItem3D = function(now, ctx, item, renderer, mbr, window, width, height, quality, floodlevel) {
    this.item3D.renderItem3D(now, ctx, item, renderer, mbr, window, width, height);
}
