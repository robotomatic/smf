...
ItemRenderManager.prototype.drawItem = function(ctx, color, item, x, y, width, height, scale, drawdetails) {
    ...
    if (titem.renderer) this.itemrenderer.render(ctx, color, titem.renderer, item, x, y, width, height, titem, scale, drawdetails);
    else this.renderer.drawItemTheme(ctx, color, item, x, y, width, height, scale, titem);
}