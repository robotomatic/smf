...
Character.prototype.draw = function(now, ctx, color, x, y, width, height, direction, state, scale, outline, debug)  { 
    ...
    this.renderer.draw(ctx, color ? color : this.color, this.width, this.height, this.animator.getMbr(), this.animator.getCharacter(), scale, outline, this.debug);
}