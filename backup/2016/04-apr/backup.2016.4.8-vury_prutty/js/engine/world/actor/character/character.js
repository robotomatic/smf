...
Character.prototype.draw = function(now, ctx, color, x, y, width, height, direction, state, outline, debug, quality)  { 
    ...
    this.renderer.draw(ctx, color ? color : this.color, this.width, this.height, this.animator.getMbr(), this.animator.getCharacter(), outline, this.debug, quality);
}