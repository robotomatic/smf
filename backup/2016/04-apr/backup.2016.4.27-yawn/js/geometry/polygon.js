...
Polygon.prototype.getId = function(id) {
    ...
    var out = distance(this.points[0].x, this.points[0].y, this.points[1].x, this.points[1].y);
    var t = 0;
