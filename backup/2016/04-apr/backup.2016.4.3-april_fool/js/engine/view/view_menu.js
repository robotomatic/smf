...
MenuView.prototype.renderLayer = function(now, stage, layer) { 
    ...
    this.renderPlayers(now, ctx, stage, view, stage.level.width, stage.level.height, dx, dy); 
}

MenuView.prototype.renderPlayers = function(now, ctx, stage, view, width, height, dx, dy) {
    ...
    for (var i = 0; i < stage.players.players.length; i++) this.renderPlayer(now, ctx, stage.players.players[i], view, width, height, dx, dy);
...
MenuView.prototype.renderPlayer = function(now, ctx, player, view, width, height, dx, dy) {
