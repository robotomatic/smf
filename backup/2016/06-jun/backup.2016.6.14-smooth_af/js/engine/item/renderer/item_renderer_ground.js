...
//    poly.craziness(3);
    ...
    this.drawPlatformTops(ctx, tops, x, y, scale, platform.colortoplight, platform);
}
...
ItemRendererGround.prototype.drawPlatformTops = function(ctx, tops, x, y, scale, color, theme) {
