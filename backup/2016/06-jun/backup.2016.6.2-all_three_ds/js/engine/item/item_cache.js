...
ItemCache.prototype.cacheItem = function(ctx, item, window, x, y, width, height, renderer, scale, details, quality, blur, parallax) {
    ...
    if (renderer) renderer.drawItem(cacheitem.ctx, item.color, item,  window, qpad / 2, qpad / 2, w, h, this.quality, details);
    else {
