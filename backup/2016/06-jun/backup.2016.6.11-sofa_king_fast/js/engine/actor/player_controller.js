...
PlayerController.prototype.update = function(now, physics) {
...
PlayerController.prototype.applyPhysics = function(now, physics) {
    if (this.velX > 0) {
...
PlayerController.prototype.updateLocation = function(now, physics) {
    ...
    if (this.move_left && this.move_right) {
        if (this.lastMoveRight < this.lastMoveLeft) this.velX = speed;
        else this.velX = -speed;
    }
    else if (this.move_left) this.velX = -speed;
