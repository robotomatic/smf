...
//        if (this.set) console.log("no touch");
        ...
        if (this.lastground && !this.jumped && !this.jumping ) {
            ...
            if (this.lastground.ramp) {
                ...
                var lastr = new Rectangle(this.lastground.x, this.lastground.y, this.lastground.width, this.lastground.height);
                lastr.ramp = this.lastground.ramp;

                var p = getProjectedPoint(this, lastr);
                if (p) {


                    var ddd = distance(this.x + this.width /2, this.y + this.height, p.x, p.y);
