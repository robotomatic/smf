...
CharacterAnimator.prototype.animate = function(now, box, direction, state, character) {
    ...
    this.createCharacterPuppet(this.character);
...
//    return;
    ...
    // todo: can state animations be cached?
    // default - idle
    // tail - idle
    // etc - idle
    
    
    // does it make sense to re-use managers?
    ...
    for (var animtype in this.animations) {
        ...
        var animname = animtype + "-" + state; // <--- here is a good place to cache!!!
