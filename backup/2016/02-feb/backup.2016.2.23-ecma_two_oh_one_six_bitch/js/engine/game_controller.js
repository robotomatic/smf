...
//    let head = document.getElementById("main-content-head");
//    head.className = head.className.replace(/game-ui/g, '');
    let foot = document.getElementById("main-content-foot");
    foot.className = foot.className.replace(/game-ui/g, '');
    foot.className += " fade-border";
    let buttons = document.getElementsByClassName("menu-game-button-icon");
    for (let i = 0; i < buttons.length; i++) {
        buttons[i].className = buttons[i].className.replace(/game-ui shadow/g, '');
        buttons[i].className += " ui-shadow";
    }
    let icons = document.getElementsByClassName("menu-game-button-icon-link-icon");
    for (let i = 0; i < icons.length; i++) icons[i].className = icons[i].className.replace(/text-shadow/g, '');;
    let dev = document.getElementById("dev-ui");
    if (dev) {
...
//    head.className += " game-ui";
    ...
    let icons = document.getElementsByClassName("menu-game-button-icon-link-icon");
    for (let i = 0; i < icons.length; i++) icons[i].className += " text-shadow";
    let dev = document.getElementById("dev-ui");
    if (dev) {
...
//    showSlide(document.getElementById("main-content-head"));
    ...
    fadeIn(document.getElementById("dev-ui"));
...
//        hideSlide(document.getElementById("main-content-head"));
        ...
        fadeOutHide(document.getElementById("dev-ui"));
...
GameController.prototype.loadDevTools = function() {
    ...
    this.gameloader.loadDevToolsFile(
        "views/ui-dev.html",
        function() {
            controller.devtools = new DevTools(controller, controller.gameloader.devtools);
        }
    );
}
...
//        let buttons = document.getElementsByClassName('loader');
//        for (let i = 0; i < buttons.length; i++){
//            buttons[i].onclick = function(e){ 
//                controller.fadeOut();
//                controller.ignorepop = true;
//                let href = buttons[i].getAttribute("href");
...
//        }    
        ...
        controller.gameloader.loadMenu(
            ...
            "dat/animations.json",
            function() {
                let p = document.getElementById("menu-player-wrap");
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadMenuPlayerChooser(
            ...
            function() {
                ...
                controller.game = new MenuPlayerChooser(controller, p, 4);
...
GameController.prototype.showMenuLevelChooser = function(data) {
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadMenuLevelChooser(
            ...
            function() {
                let p = document.getElementById("menu-level-wrap");
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadGameParty(
            ...
            function() {
                ...
                let gamesettings = controller.gamesettings.getSettings("game-party");
                let levelsettings = controller.gamesettings.getSettings("menu-level-chooser");
                let playersettings = controller.gamesettings.getSettings("menu-player-chooser");
...
GameController.prototype.swapUI = function(data, callback) {
    ...
    div.innerHTML = data;
    let main = div.getElementsByClassName("main-content-wrap");
    let controller = this;
    if (main.length) {
...
//    let buttons = div.getElementsByClassName("button-wrap");
...
GameController.prototype.start = function() {
    ...
    if (this.game) {
        ...
        else { for (let i = 0; i < this.game.length; i++) this.game[i].start(); }
    }
    this.fadeIn();
...
GameController.prototype.resize = function() {
    ...
    if (this.game) {
        ...
        else { for (let i = 0; i < this.game.length; i++) this.game[i].resize(); }
    }
}
...
GameController.prototype.run = function() {
    if (this.game) {
        ...
        else { for (let i = 0; i < this.game.length; i++) this.game[i].loop.run(); }
    }
}
...
GameController.prototype.stop = function() {
    if (this.game) {
        ...
        else { for (let i = 0; i < this.game.length; i++) this.game[i].stop(); }
    }
}

GameController.prototype.fadeIn = function() {
    fadeIn(this.maincontent);
//    for (let i = 0; i < this.maincontent.childNodes.length; i++) fadeIn(this.maincontent.childNodes[i]);
    let buttons = document.getElementsByClassName("menu-game-button-icon-link");
    for (let i = 0; i < buttons.length; i++) fadeIn(buttons[i]);
}

GameController.prototype.fadeOut = function() {
    fadeOut(this.maincontent);
//    for (let i = 0; i < this.maincontent.childNodes.length; i++) fadeOutHide(this.maincontent.childNodes[i]);
    let buttons = document.getElementsByClassName("menu-game-button-icon-link");
    for (let i = 0; i < buttons.length; i++) fadeOut(buttons[i]);
}