...
CharacterRenderer.prototype.draw = function(ctx, color, width, height, box, character, scale, outline, debug) {

    this.outline.draw = ((box.width * scale) < this.outline.threshold) ? false : outline;
    this.debug = debug;
