...
PlayerCollider.prototype.handleCollide = function(player, collider, result) {
    ...
    if (collider.action) collider = this.handleCollideAction(player, collider, result);
...
PlayerCollider.prototype.handleCollideAction = function(player, collider, result) {
    if (collider.action.x) return this.handleCollideActionHorizontal(player, collider, result);
    if (collider.action.y) return this.handleCollideActionVertical(player, collider, result);
    return result;
}
