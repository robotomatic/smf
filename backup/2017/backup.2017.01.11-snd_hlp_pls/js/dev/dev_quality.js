...
function initializeDevQuality() {
    ...
    document.getElementById("dev-quality-player-player").onchange = function() {
        setQualityPlayer(this.value);
    };
    document.getElementById("dev-quality-player-range").onchange = function() {
        setQualityPlayer(this.value);
    };
    document.getElementById("dev-quality-player-player-range").onchange = function() {
        setQualityPlayer(this.value);
    };
...
function updateDevViewQuality(v) {
    ...
    pp.value = pq;
    var ppq = document.getElementById("dev-quality-player-player");
    ppq.value = pq;
    var ppp = document.getElementById("dev-quality-player-range");
    ppp.value = pq;
    var pppq = document.getElementById("dev-quality-player-player-range");
    pppq.value = pq;
