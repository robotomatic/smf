...
CharacterAnimator.prototype.animate = function(box, direction, state, character) {
    ...
    if (direction) animstates[animstates.length] = direction;
    if (state) animstates[animstates.length] = state;
    if (state && direction) animstates[animstates.length] = state + "_" + direction;
