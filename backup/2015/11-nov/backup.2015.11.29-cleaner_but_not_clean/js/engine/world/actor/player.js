...
//    return (state || direction) ? new Array(direction, state, (state && direction) ? state + "_" + direction : "") : null;
//}
...
//    if (!this.ready) return;
   ...
   if (this.character) this.character.draw(ctx, this.color, x, y, width, height, dir, state, scale);
    else {
