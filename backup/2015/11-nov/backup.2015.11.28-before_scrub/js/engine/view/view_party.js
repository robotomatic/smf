...
//    var dy = (diff_height > 0) ? diff_height : 0;
    ...
    if (layer.cache === true) {
        ...
        if (layername == "players") this.renderPlayers(delta, ctx, stage, cmbrtrans, mbr_x, mbr_y, scale, dy, false);
        else this.renderLayerItems(delta, canvas, ctx, cmbrtrans, stage.level, layer, mbr_x, mbr_y, scale, dy, false);
    }
