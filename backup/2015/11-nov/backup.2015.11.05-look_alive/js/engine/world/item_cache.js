...
ItemCache.prototype.cacheItem = function(ctx, item, x, y, width, height, renderer, outline, outlinewidth, scale) {
    ...
    if (needrender) {
        if (renderer) renderer.drawItem(cacheitem.ctx, item.color, item, 0, 0, item.width, item.height, this.lighten, outline, outlinewidth ? outlinewidth : this.outlinewidth, scale);
        else {
