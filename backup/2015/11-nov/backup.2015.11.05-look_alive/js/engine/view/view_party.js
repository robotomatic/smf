...
PartyView.prototype.renderLayer = function(delta, stage, layer) { 
    ...
    var pad = (opp.length == 1) ? this.viewpad * 2 : this.viewpad;
    var mbr = getMbr(opp, pad);

//    if (opp.length > 1){
//        var viewBuffer = 1000 * (mbr.width / stage.level.width);
//        mbr = getMbr(opp, viewBuffer);
//    }
    ...
    if (opp.length == 1) dy += this.viewpad / 2;
