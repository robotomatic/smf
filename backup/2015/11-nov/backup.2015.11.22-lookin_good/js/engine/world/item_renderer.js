...
ItemRenderer.prototype.drawItem = function(ctx, color, item, x, y, width, height, lighten, outline, outlinewidth, scale, drawdetails) {
    ...
    // todo: this is gross.
    if (item.itemtype == "wave" || item.itemtype == "wave-1" || item.itemtype == "wave-2") {
        ...
        return;
    } else if (item.itemtype == "gear" || item.itemtype == "gear-bg") {
        this.gearsrenderer.drawGear(ctx, item, x, y, width, height, titem, drawdetails);
        return;
    } else if (item.itemtype == "clouds" || item.itemtype == "clouds-mid" || item.itemtype == "clouds-fg") {
