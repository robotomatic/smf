...
Player.prototype.getDirection = function() {
    ...
    if (lookLeft) return "look_left";
    else if (lookRight) return "look_right";
}
...
Player.prototype.getState = function() {
    ...
    else if (this.isMovingLeft()) state = "walk_left";
    else if (this.isMovingRight()) state = "walk_right";
    else if (!this.isLookingLeft() && !this.isLookingRight()) state = "idle";
    return state;
}

Player.prototype.draw = function(ctx, x, y, width, height) {
    if (this.character) this.character.draw(ctx, this.color, x, y, width, height, this.getState(), this.getDirection());
    else {
