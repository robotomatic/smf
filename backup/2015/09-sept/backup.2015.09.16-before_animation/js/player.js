...
Player.prototype.getState = function() {
    var state = "idle";
    if (this.falling) state = "falling";
    else if (this.jumping) state = "jumping";
    else if (this.isMovingLeft()) state = "walking";
    else if (this.isMovingRight()) state = "walking";
    return state;
}

Player.prototype.draw = function(ctx, x, y, width, height) {
    if (this.character) this.character.draw(ctx, this.color, x, y, width, height, this.getState());
    else {
