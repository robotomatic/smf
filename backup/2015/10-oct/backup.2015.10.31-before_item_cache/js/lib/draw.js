...
function drawRoundTriangle(ctx, triangle, x, y, width, height, radius) {
    var dradius = 2 * radius;
    ctx.beginPath();
    if (triangle.ramp == "left") {
        ctx.moveTo(x + dradius, y);
        ctx.lineTo(x + width - dradius, y + height - dradius);
        ctx.arcTo(x + width, y + height, x + width - radius, y + height, radius);
        ctx.lineTo(x + radius, y + height);
        ctx.quadraticCurveTo(x, y + height, x, y + height - radius);
        ctx.lineTo(x, y + radius);
        ctx.arcTo(x, y, x + dradius, y, radius);
    } else {
        ctx.moveTo(x + dradius, y + height - dradius);
        ctx.lineTo(x + width - dradius, y);
        ctx.arcTo(x + width, y, x + width, y + dradius, radius);
        
        ctx.lineTo(x + width, y + height - radius);
        ctx.quadraticCurveTo(x + width, y + height, x + width - radius, y + height);
        
        ctx.lineTo(x + dradius, y + height);
        ctx.arcTo(x, y + height, x + dradius, y + height - dradius, radius);
    }
    ctx.closePath();
    ctx.fill();    
}
