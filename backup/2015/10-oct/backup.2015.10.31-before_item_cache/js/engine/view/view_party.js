...
PartyView.prototype.renderLayer = function(delta, stage, layer) { 
    ...
    var mbr = getMbr(opp, this.viewpad);
...
//    if (layer.name == "front-crates" && index == 0 && ix != this.lastp) {
//        console.log(ix);
//        this.lastp = ix;
//    }
    
    
    layer.drawItem(ctx, item, itemx, itemy, itemwidth * layer.scale, itemheight * layer.scale, level.itemrenderer, outline, scale);
}
