function MenuPlayer(loader) {
    ...
    this.ui = document.getElementById("menu-canvas-ui");
...
MenuPlayer.prototype.loadView = function() {
    ...
    var z = 10;
    var w = 1200, h = 600;
    this.loop.loadViews(new Array(new CharacterView("menu-canvas", 0, menubox, w, h, z, this.devtools)));
    this.loadUI();
}
