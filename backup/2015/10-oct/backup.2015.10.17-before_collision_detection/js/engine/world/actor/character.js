...
Character.prototype.draw = function(ctx, color, x, y, width, height, animationstates, outline)  { 
    var box = {
        "x" : x,
        "y" : y,
        "width" : width,
    ...
    this.renderer.draw(ctx, color ? color : this.color, animated.box, animated.character, outline);
}