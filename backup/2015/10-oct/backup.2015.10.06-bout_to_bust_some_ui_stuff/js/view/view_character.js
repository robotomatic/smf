function CharacterView(id, playernum, menubox, width, height, zoom, devtools) {
    this.id = id;
...
CharacterView.prototype.resizeUI = function() { 
    if (this.view.devtools) this.view.resizeDevUI();
}
