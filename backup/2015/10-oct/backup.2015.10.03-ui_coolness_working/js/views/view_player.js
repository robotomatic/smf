...
PlayerView.prototype.setUI = function(ui) { 
    this.ui = ui; 
    this.parent.appendChild(ui.getUI());
}

PlayerView.prototype.setDevTools = function(dev) { 
    return;
    this.dev = dev; 
...
PlayerView.prototype.resizeUI = function() {
    if (this.ui) {
        ...
        var pad = -15;
        var uileft = left + viewleft + pad;
        var uitop = top + viewtop + pad;
        var uiwidth = view.width;
        var uiheight = 100;
...
PlayerView.prototype.updateUI = function() {
    ...
    var m = document.getElementById("menu-canvas-text");
    m.innerHTML = this.player.character.name;
}