...
View.prototype.render = function(delta, stage) {
    if (!this.dorender) {
        ...
        if (stage.level.itemrenderer.background && stage.level.itemrenderer.background.color) this.canvas_render.style.background = stage.level.itemrenderer.background.color;
