function MenuPlayerChooser(loader, parent, playertotal, devtools) {
    this.menu = new Menu(devtools);
...
MenuPlayerChooser.prototype.loadView = function(i) {
    ...
    this.loadUI(i);
    return new CharacterView(i + "-ui-player-chooser-canvas", i, menubox, w, h, z);
}
...
MenuPlayerChooser.prototype.loadUI = function(playernum) {
    ...
    var playercard = document.getElementById(playernum + "-ui-player-chooser-start-card");
    var start = document.getElementById(playernum + "-ui-player-chooser-button-start");
    if (start) {
        start.onclick = function(e) {
            playercard.className += " flipped";
            e.preventDefault();
            return false;
        }
    }
    var exit = document.getElementById(playernum + "-ui-player-chooser-button-exit");
    if (exit) {
        exit.onclick = function(e) {
            playercard.className = playercard.className.replace(/flipped/g, '');
            e.preventDefault();
            return false;
        }
    }
    ...
    if (custom) {
        ...
        var customok = document.getElementById(playernum + "-ui-player-chooser-custom-button-ok");
