...
GameController.prototype.showGamePlayer = function(data) {
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadGamePlayer(
            "dat/levels/level2.json",
            "dat/items.json",
            "dat/players.json", 
            "dat/characters.json", 
            "dat/animations.json",
            function() {
                controller.currentview = "game-player";
                controller.game = new GamePlayer(controller.gameloader, controller.devtools, controller.gamesettings.getSettings(controller.currentview));
    ...
    this.loadUI(data, function() {
        controller.gameloader.loadGameParty(
            ...
            function() {
                ...
                controller.game = new GameParty(controller.gameloader, controller.devtools, controller.gamesettings.getSettings(controller.currentview));
                controller.start();
            }
        );
    });
