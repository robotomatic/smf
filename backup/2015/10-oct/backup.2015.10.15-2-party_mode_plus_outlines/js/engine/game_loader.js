...
GameLoader.prototype.loadGameParty = function(levelfile, itemsfile, charfile, animfile, callback) {
    this.reset();
    this.callback = callback;
    var loader = this;
    var testComplete = function() {
        if (loader.level && loader.items && loader.characters && loader.animations) {
            if (loader.callback) loader.callback();
            return false;
        }
    }
